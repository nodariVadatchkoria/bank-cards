...
export const translations: Record<Language, Translations> = {
  ...
  ka: {
    ...
    foundExpiringCards: "ნაპოვნია {count} ბარათი, ჩიპის 2 წელზე ნაკლები მოქმედების ვადით",
    allChipsValid: "ყველა ბარათის ჩიპი 2 წელზე მეტი ვადით მოქმედებს",
    actionRequired: "მოქმედება საჭიროა",
    actionRequiredDescription: "შემდეგ ბარათებს აქვთ ჩიპები, რომლებსაც მომდევნო 2 წელში ვადას გაუვათ. მოახდინეთ ბარათის მწარმოებელთან დაკავშირება ჩანაცვლების ან განახლების მიზნით.",
